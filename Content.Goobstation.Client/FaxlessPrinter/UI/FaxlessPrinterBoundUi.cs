...
using Content.Client.Fax;
using Content.Goobstation.Client.FaxlessPrinter;
using Content.Goobstation.Client.FaxlessPrinter.UI;

namespace Content.Goobstation.Client.FaxlessPrinter.UI;

[UsedImplicitly]
public sealed class FaxlessPrinterBoundUserInterface : BoundUserInterface
{
    ...
    public FaxlessPrinterBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
    ...
    protected override void Open()
    {
        ...
        _window = this.CreateWindow<FaxlessPrinterWindow>();
    ...
    protected override void UpdateState(BoundUserInterfaceState state)
    {
        ...
        if (_window == null || state is not FaxlessPrinterUiState cast)
            return;
